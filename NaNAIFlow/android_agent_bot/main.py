...
def main() -> None:
    ...
    recovered_jobs = db.recover_running_jobs()
    ...
    telegram.set_commands(
        [
            ...
            {"command": "buildbyprompt", "description": "Build app from appid and prompt"},
            ...
            {"command": "editapp", "description": "Queue app edit task for a job"},
    ...
    if recovered_jobs:
        print(f"recovered {recovered_jobs} running job(s) to queued on startup")
