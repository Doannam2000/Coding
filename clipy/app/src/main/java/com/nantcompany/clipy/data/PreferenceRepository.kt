...
class PreferenceRepository(private val context: Context) {
  ...
  suspend fun updateDefaults(gifFps: Int, gifResolution: String, quality: Mp4Quality, cropRatio: CropRatio, saveBehavior: SaveBehavior, defaultMuteEnabled: Boolean) {
